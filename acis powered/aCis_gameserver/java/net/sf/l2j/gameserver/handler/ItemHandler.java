...
import Extensions.ItemHandlers.ClanRepsItem;
import Extensions.ItemHandlers.LuckyScroll;
import Extensions.ItemHandlers.RandomRewardBox;
import Extensions.ItemHandlers.SkillGiver;
...
public class ItemHandler
{
	...
	protected ItemHandler()
	{
		...
		if (Config.ALLOW_REWARD_BOX)
			registerItemHandler(new RandomRewardBox());
		if (Config.ALLOW_SKILL_GIVER)
			registerItemHandler(new SkillGiver());
		if (Config.USE_CR_ITEM)
			registerItemHandler(new ClanRepsItem());
		
		registerItemHandler(new LuckyScroll());
	}
