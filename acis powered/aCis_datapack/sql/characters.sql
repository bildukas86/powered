CREATE TABLE IF NOT EXISTS characters (
  ...
  `startupstage` SMALLINT UNSIGNED DEFAULT 1,
  ...
  `lastVoteHopzone` BIGINT UNSIGNED DEFAULT NULL,
  `lastVoteTopzone` BIGINT UNSIGNED DEFAULT NULL,
  `hasVotedHop` INT UNSIGNED DEFAULT 0,
  `hasVotedTop` INT UNSIGNED DEFAULT 0,
  `monthVotes` INT UNSIGNED DEFAULT 0,
  `totalVotes` INT UNSIGNED DEFAULT 0,
  `tries` INT UNSIGNED DEFAULT 3,
  `pin` int(4) DEFAULT NULL,
  `pinsubmited` int(4) DEFAULT 1,
  `partyMatchingStatus` SMALLINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (obj_Id),
  KEY `clanid` (`clanid`)
);